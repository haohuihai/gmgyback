...
function clock (id) {
  ...
  ctx.restore()
  // 将名片存到/assets/user/card文件夹下
  canvas.createPNGStream().pipe(fs.createWriteStream(path.join(__dirname, id + '.png')))
}
...
//   canvas.createPNGStream().pipe(fs.createWriteStream(path.join(__dirname, 'clock1.png')))
// }
